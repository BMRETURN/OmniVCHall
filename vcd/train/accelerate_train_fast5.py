...
def build_parser():
    parser = argparse.ArgumentParser(description="Fast distributed training entry (5-GPU) for vcd_new")
...
def main():
    ...
    log(f"Loading model and processor on rank={rank}, device={device} ...", rank)
